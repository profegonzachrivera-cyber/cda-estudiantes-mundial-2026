  ...
  return (
    <main className="min-h-screen bg-slate-900 text-white flex flex-col items-center p-8">
      ...
      <p className="text-xl text-center max-w-3xl mb-8">
        Vive la emoción del Mundial de Fútbol FIFA 2026. Predice los resultados
        del torneo que se disputará en Estados Unidos, Canadá y México, acumula
        puntos, sigue el ranking oficial y compite por premios en efectivo
        mientras apoyas al Club Deportivo Estudiantes de Calbuco.
      </p>
      ...
      <div className="bg-slate-800 p-8 rounded-xl max-w-3xl w-full shadow-xl">
        ...
        <h2 className="text-2xl font-bold mb-4">🎯 Sistema de Puntuación</h2>
        ...
        <h2 className="text-2xl font-bold mb-4">📋 Reglas Generales</h2>

        <ul className="space-y-2 mb-8">
          <li>• Cada participante puede registrar una sola cuenta.</li>
          <li>• El pago debe estar confirmado para participar.</li>
          <li>
            • Los pronósticos para cada fase deberán registrarse antes de una
            hora del inicio de dicha fase. Una vez cerrada la fase, no se podrán
            realizar modificaciones.
          </li>
          <li>
            • El ranking se actualizará al finalizar cada fecha de la Fase de
            Grupos y posteriormente al término de cada ronda eliminatoria:
            Dieciseisavos de Final, Octavos de Final, Cuartos de Final,
            Semifinales y Final.
          </li>
          <li>
            • En caso de empate en la clasificación final, se utilizará el
            número de resultados exactos acertados como criterio de desempate.
          </li>
          <li>
            • La participación implica la aceptación de todas las reglas del
            concurso.
          </li>
          <li>
            • La organización resolverá cualquier situación no contemplada en
            las reglas.
          </li>
        </ul>

        <h2 className="text-2xl font-bold mb-4">🎮 ¿Cómo se juega?</h2>
